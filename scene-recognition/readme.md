...
* Fields:
    ...
    * `scene-type` - string representing the type label
    * `subtype label` - string representing the subtype label, if applicable
    * `modifier` - boolean representing the presence of a modifier, default is False
