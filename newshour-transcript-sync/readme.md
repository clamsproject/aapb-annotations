...
Eg. in raw file [cpb-aacip-507-1v5bc3tf81.srt](cpb-aacip-507-1v5bc3tf81.srt), annotation #6 has a duration of 40s instead of the usual 4-5s.  
...
The datasets in this project are unvalidated for errors and precision. The assumption/hope is that the time error is approximately similar as described in the [repository_level_conventions.md](repository_level_conventions.md).
